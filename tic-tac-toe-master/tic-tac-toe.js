...
function checkwin(y,val){
    ...
    if(y==0 || y==1||y==2){
        psbs[0][y]=val;
        allEqual(psbs[0])?win=true:console.log("not same suh")
    }
    if(y==3|| y==4||y==5){
        psbs[1][y-3]=val;
        allEqual(psbs[1])?win=true:console.log("not same suh")
    }
    if(y==6|| y==7||y==8){
        psbs[2][y-6]=val;
    ...
    if(y==0|| y==3||y==6){
        ...
        if(y==0)psbs[3][0]=val
        if(y==6)psbs[3][2]=val
        allEqual(psbs[3])?win=true:console.log("not same suh")
    }
    if(y==1|| y==4||y==7){
        if(y==1)psbs[4][0]=val
        if(y==4)psbs[4][1]=val
        if(y==7)psbs[4][2]=val
        allEqual(psbs[4])?win=true:console.log("not same suh")
    }
    if(y==2|| y==5||y==8){
        if(y==2)psbs[5][0]=val
        if(y==5)psbs[5][1]=val
        if(y==8)psbs[5][2]=val
        allEqual(psbs[5])?win=true:console.log("not same suh")
    }
    if(y==0|| y==4||y==8){
        if(y==0)psbs[6][0]=val
        if(y==4)psbs[6][1]=val
        if(y==8)psbs[6][2]=val
        allEqual(psbs[6])?win=true:console.log("not same suh")
    }
    if(y==2|| y==4||y==6){
        if(y==2)psbs[7][0]=val
        if(y==4)psbs[7][1]=val
